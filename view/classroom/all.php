    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">جدول کلاس ها</h3>
...
<!--                            </div>-->
<!--                        </div>-->
                        <a href="create.php" class="btn btn-primary text-white mx-1 ">ایجاد کلاس</a>
                    </div>
                </div>
            </div>
            <!-- /.card-header -->
                    ...
                    <tr>
                        ...
                        <td><?= $key->id ?>
                            <div class="d-flex mt-3">
                                <form action="/view/classroom/edit.php" id="edit-form-<?= $key->id ?>">
                                ...
                                <form action="/app/Controll/ClassRoom/deleteController.php" method="post">
